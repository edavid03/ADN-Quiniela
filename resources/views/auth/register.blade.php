...
@section('content')
    <section class="relative w-full max-w-6xl overflow-hidden rounded-lg border border-[var(--app-border)] bg-[var(--app-panel)] shadow-[0_30px_90px_rgba(18,11,36,.18)]">
        <div class="grid lg:grid-cols-[.78fr_1.22fr]">
            <aside class="relative overflow-hidden bg-[var(--fwc-primary)] p-7 text-white sm:p-9 lg:p-10">
                ...
                <div class="relative flex h-full min-h-72 flex-col justify-between gap-10">
                    <div>
                        <span class="kicker text-[var(--fwc-accent)]">Nueva convocatoria</span>
                        <h1 class="mt-5 font-display text-5xl font-black leading-[1.02] sm:text-6xl">Entra a la quiniela</h1>
